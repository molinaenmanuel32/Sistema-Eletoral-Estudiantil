...
namespace SistemaVotacion.UI.Controls
{
    public partial class UcPlanchas : UserControl
    {
        ...
        private void DgvPlanchas_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgvPlanchas.CurrentRow.Cells["PlanchaId"].Value == null)
                return;

            int id = Convert.ToInt32(
                dgvPlanchas.CurrentRow.Cells["PlanchaId"].Value
            );
            ...
            lblPlancha.Text =
                "Miembros de " + _planchaSeleccionada.Nombre;
        ...
        {
            FrmEditarPlancha frm = new FrmEditarPlancha(null);
        ...
        private void BtnEditar_Click(object sender, EventArgs e)
        {
            ...
            FrmEditarPlancha frm =
                new FrmEditarPlancha(_planchaSeleccionada);
        ...
        private static DataGridViewTextBoxColumn ColText(
            string name,
            string header,
            int w)
        {
        ...
        private static DataGridViewCheckBoxColumn ColCheck(
            string name,
            string header,
            int w)
        {
        ...
        private static DataGridViewImageColumn ColImage(
            string name,
            string header,
            int w)
        {
